...
class FeaturesExtractor():
    ...
    def extract_features(self, group):
        ...
        # if group=='train':
        #     safe_makedir(feat_dir)
        #     for ft in os.listdir(os.path.join(self.feat_dir,'enroll')):
        #         ft_loc = os.path.join(self.feat_dir,'enroll',ft)
        #         shutil.copyfile(ft_loc, os.path.join(feat_dir, ft)) # copy enrol features to training features folder
        #     for ft in os.listdir(os.path.join(self.feat_dir,'test')):
        #         ft_loc = os.path.join(self.feat_dir,'test',ft)
        #         shutil.copyfile(ft_loc, os.path.join(feat_dir, ft)) # copy test features to training features folder
        #     return
